  ...
  handleParentDropdownChange(event) {
    ...
    if (this.parentValue === BI_PSP_chatterLifestyle) {
      this.childOptions = [
        ...
        {
          label: BI_PSP_chatterLifeNotAlways,
          value: BI_PSP_chatterLifeNotAlways
        },
        ...
        {
          label: BI_PSP_chatterLifeAfterOver,
          value: BI_PSP_chatterLifeAfterOver
        },
        {
          label: BI_PSP_chatterLifeThereAre,
          value: BI_PSP_chatterLifeThereAre
        },
      ...
      this.childOptions = [
        {
          label: BI_PSP_chatterSocialActivelyWork,
          value: BI_PSP_chatterSocialActivelyWork
        },
        {
          label: BI_PSP_chatterSocialToExplain,
          value: BI_PSP_chatterSocialToExplain
        },
        {
          label: BI_PSP_chatterSocialTalking,
          value: BI_PSP_chatterSocialTalking
        },
        {
        ...
        {
          label: BI_PSP_chatterSocialSharedMy,
          value: BI_PSP_chatterSocialSharedMy
        },
        {
          label: BI_PSP_chatterSocialStaying,
          value: BI_PSP_chatterSocialStaying
        },
        {
          label: BI_PSP_chatterSocialWantToIntimate,
          value: BI_PSP_chatterSocialWantToIntimate
        },
        {
          label: BI_PSP_chatterSocialGotChance,
          value: BI_PSP_chatterSocialGotChance
        },
        {
        ...
        {
          label: BI_PSP_chatterSocialThingsBetter,
          value: BI_PSP_chatterSocialThingsBetter
        }
      ];
    } else if (this.parentValue === BI_PSP_chatterMedical) {
      this.childOptions = [
        {
          label: BI_PSP_chatterMedicalDontFeel,
          value: BI_PSP_chatterMedicalDontFeel
        },
        {
        ...
        {
          label: BI_PSP_chatterMedicalFinally,
          value: BI_PSP_chatterMedicalFinally
        }
      ];
      ...
      this.childOptions = [
        ...
        {
          label: BI_PSP_chatterPsycFeelAnxious,
          value: BI_PSP_chatterPsycFeelAnxious
        },
        {
        ...
        {
          label: BI_PSP_chatterPsycThingsBetter,
          value: BI_PSP_chatterPsycThingsBetter
        },
        {
          label: BI_PSP_chatterPsycDontLetGpp,
          value: BI_PSP_chatterPsycDontLetGpp
        },
        {
          label: BI_PSP_chatterPsycGPPHardBattle,
          value: BI_PSP_chatterPsycGPPHardBattle
        },
        {
        ...
        {
          label: BI_PSP_chatterPsycEvenThough,
          value: BI_PSP_chatterPsycEvenThough
        },
        {
          label: BI_PSP_chatterPsycIAccept,
          value: BI_PSP_chatterPsycIAccept
        }
      ];
      ...
      this.childOptions = [
        ...
        {
          label: BI_PSP_chatterOccWorlColleague,
          value: BI_PSP_chatterOccWorlColleague
        },
        {
          label: BI_PSP_chatterOccFeelMyFamily,
          value: BI_PSP_chatterOccFeelMyFamily
        }
      ];
    } else if (this.parentValue === BI_PSP_chatterGPP) {
      this.childOptions = [
        {
          label: BI_PSP_chatterGppIDontKnow,
          value: BI_PSP_chatterGppIDontKnow
        },
        {
          label: BI_PSP_chatterGppWhileGiving,
          value: BI_PSP_chatterGppWhileGiving
        },
        {
        ...
        {
          label: BI_PSP_chatterGppActivelyExplore,
          value: BI_PSP_chatterGppActivelyExplore
        },
        {
          label: BI_PSP_chatterGppUnderstanding,
          value: BI_PSP_chatterGppUnderstanding
        },
        {
          label: BI_PSP_chatterGppFeelAlone,
          value: BI_PSP_chatterGppFeelAlone
        }
      ];
    }
  }
    ...
    try {
      checkCommunityUsername({ userId: this.userId })
        .then((result) => {
          if (result === true) {
            window.location.assign(
              BI_PSP_ChatterSlash + this.urlq + BI_PSPB_MyPostUrl
            );
