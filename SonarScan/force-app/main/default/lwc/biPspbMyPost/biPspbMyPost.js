...
export default class biPspbMyPost extends LightningElement {
  ...
  connectedCallback() {
    try {
      ...
      const selectedItemIdforComment = window.localStorage.getItem(
  ...
  follorunfollemoji(event) {
    ...
    try {
      emojiFollow({
        loggedAccountId: this.UserAccId,
        ...
        if (result && result.length > 0) {
          ...
          if (
            ...
            this.commentoption = [
              ...
              {
                label: BI_PSP_chatterOptAwesome,
                value: BI_PSP_chatterOptAwesome
              },
              {
                label: BI_PSP_chatterOptKeepItUp,
                value: BI_PSP_chatterOptKeepItUp
              },
              {
                label: BI_PSP_chatterOptEnjoyReality,
                value: BI_PSP_chatterOptEnjoyReality
            ...
            this.commentoption = [
              {
                label: BI_PSP_chatterOptGetEasy,
                value: BI_PSP_chatterOptGetEasy
              },
              {
                label: BI_PSP_chatterOptRootingForYou,
                value: BI_PSP_chatterOptRootingForYou
            ...
            this.commentoption = [
              ...
              {
                label: BI_PSP_chatterOptAmazing,
                value: BI_PSP_chatterOptAmazing
              },
              {
                label: BI_PSP_chatterOptHappyForU,
                value: BI_PSP_chatterOptHappyForU
            ...
            this.commentoption = [
              {
                label: BI_PSP_chatterOptTryNotTo,
                value: BI_PSP_chatterOptTryNotTo
              },
              {
                label: BI_PSP_chatterOptEmbarrased,
                value: BI_PSP_chatterOptEmbarrased
            ...
            this.commentoption = [
              {
                label: BI_PSP_chatterOptFeltSame,
                value: BI_PSP_chatterOptFeltSame
              },
              {
                label: BI_PSP_chatterOptTalkingDoctor,
                value: BI_PSP_chatterOptTalkingDoctor
            ...
            this.commentoption = [
              ...
              {
                label: BI_PSP_chatterOptGoodHear,
                value: BI_PSP_chatterOptGoodHear
              },
              {
                label: BI_PSP_chatterOptWonderful,
                value: BI_PSP_chatterOptWonderful
              }
            ];
          } else if (
            title === BI_PSP_chatterPsychologi &&
            ...
            this.commentoption = [
              {
                label: BI_PSP_chatterOptDisease,
                value: BI_PSP_chatterOptDisease
              },
              {
                label: BI_PSP_chatterOptKeepItUp,
                value: BI_PSP_chatterOptKeepItUp
            ...
            this.commentoption = [
              {
                label: BI_PSP_chatterOptHopeOut,
                value: BI_PSP_chatterOptHopeOut
              },
              {
                label: BI_PSP_chatterOptKeepItUp,
                value: BI_PSP_chatterOptKeepItUp
            ...
            this.commentoption = [
              {
                label: BI_PSP_chatterOptWillPass,
                value: BI_PSP_chatterOptWillPass
              },
              {
                label: BI_PSP_chatterOptGoingFine,
                value: BI_PSP_chatterOptGoingFine
            ...
            this.commentoption = [
              {
                label: BI_PSP_chatterNoComments,
                value: BI_PSP_chatterNoComments
              }
            ];
          }
        }
