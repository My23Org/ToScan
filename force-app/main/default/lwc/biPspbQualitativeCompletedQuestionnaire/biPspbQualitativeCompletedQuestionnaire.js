...
import getqsq1Assessments from '@salesforce/apex/BI_PSP_CompletedQuestionareS.getQSQcompletedQuestionaressec';
...
export default class BiPspbQualitativeCompletedQuestionnaire extends LightningElement {
	...
	@wire(getqsq1Assessments, { targetDate: '$selectedAssessment' })
			...
			if (data) {
				...
				this.records.forEach((record) => {
					...
					if (record.BI_PSP_ResponseOrder__c === 5) {
						this.isFiveThere = yesLabel; //new one
				...
				// Check if data or error is available
	...
	navigateToCategory5() {
		if (this.target2monthsdate != null && this.assessmentlen > 0) {
