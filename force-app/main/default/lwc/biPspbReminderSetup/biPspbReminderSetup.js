...
export default class BiPspbReminderSetup extends LightningElement {
  ...
  renderedCallback() {
    ...
    [Dec, Nov, Oct, Sep, Aug, July, June, May, April, March, Feb, Jan].forEach(
      (className) => {
  ...
  handle14(event) {
    ...
    this.value1 = event.target.checked
  ...
  handle10(event) {
    ...
    this.value2 = event.target.checked
      ? parseInt(event.target.value, 10)
      : null;
    // Update value array based on checkbox state
    if (event.target.checked) {
  ...
  handle7(event) {
    ...
    this.value3 = event.target.checked
      ? parseInt(event.target.value, 10)
      : null;
    // Update value array based on checkbox state
    if (event.target.checked) {
  ...
  handle3(event) {
    ...
    this.treatvalue1 = event.target.checked
      ? parseInt(event.target.value, 10)
      : null;
  ...
  handle1(event) {
    ...
    this.treatvalue2 = event.target.checked
      ? parseInt(event.target.value, 10)
      : null;
  ...
  handle_Success() {
    ...
    if (
      ...
      const selectedDateFormatted = this.formatDate(
